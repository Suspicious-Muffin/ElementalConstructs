...
public class ItemObsidianShovel extends ItemSpade 
{
	...
	public ItemObsidianShovel(int par1, EnumToolMaterial par2EnumToolMaterial) {
	...
	{
		itemIcon = register.registerIcon(ItemInfo.TEXTURE_LOCATION + ":" + ItemInfo.OBSIDIAN_SHOVEL_ICON);
	}
